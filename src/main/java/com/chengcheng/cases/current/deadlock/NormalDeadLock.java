package com.chengcheng.cases.current.deadlock;
...
public class NormalDeadLock {
	...
	private static void SecondToFisrt() throws InterruptedException {
		String threadName = Thread.currentThread().getName();
		synchronized (valueSecond) {  // 将valueSecond替换成valueFirst 01
			System.out.println(threadName + " get 1st");
			Thread.sleep(100);
			synchronized (valueFirst) {  // 将valueFirst替换成valueSecond 02 => 01与 02步骤操作后,死锁解决
				System.out.println(threadName + " get 2nd");
			}
		}
	}
