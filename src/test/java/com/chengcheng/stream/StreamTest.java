package com.chengcheng.stream;

import com.chengcheng.PersonalBlogApplicationTests;
import com.chengcheng.entity.casesmodel.streamModel.User;
...
@Api("JDK1.8新特性 Stream的测试类")
public class StreamTest extends PersonalBlogApplicationTests {
	...
	/**
	 * 1. forEach() 使用该方法迭代流中的每个数据 -> 迭代输出每条数据.
	 */
	@Test
